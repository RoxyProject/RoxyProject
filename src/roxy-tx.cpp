...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Roxy Core roxy-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  roxy-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded roxy transaction") + "\n" +
                               "  roxy-tx [options] -create [commands]   " + _("Create hex-encoded roxy transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded roxy transaction
