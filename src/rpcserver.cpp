...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ROXY features */
        {"roxy", "masternode", &masternode, true, true, false},
        {"roxy", "masternodelist", &masternodelist, true, true, false},
        {"roxy", "mnbudget", &mnbudget, true, true, false},
        {"roxy", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"roxy", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"roxy", "mnsync", &mnsync, true, true, false},
        {"roxy", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"roxy", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use roxyd, or the -server option to roxy-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> roxy-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:832/\n";
}
