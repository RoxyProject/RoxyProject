...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(  0, uint256("0x00000ed10d9a7b1649a656e032b1d1f4b332dfc079342557f381f1ee15cef8f8"))
    (103, uint256("0x00000db636bfdbdec383fbe416f3b9f5fda4b0e1a8150ff7325a0d3f6d7b58bd"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1524943705, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 1000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Best currency Roxy starts today 4/27/2018";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1524828188;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 293572;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x00000ed10d9a7b1649a656e032b1d1f4b332dfc079342557f381f1ee15cef8f8"));
        assert(genesis.hashMerkleRoot == uint256("0x071ea391d9baefcaffcc4b5aa19217aa1ee48cfe3b8e27848801037575389510"));
        

        vSeeds.push_back(CDNSSeedData("seed1.roxyproject.com", "seed1.roxyproject.com"));
        vSeeds.push_back(CDNSSeedData("seed2.roxyproject.com", "seed2.roxyproject.com"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Roxy BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Roxy BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Roxy BIP44 coin type is '1' (All coin's testnet default)
