...
#if defined(NDEBUG)
#error "Roxy cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Roxy Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 1) return 150000 * COIN;
        else if (nHeight > 1 && nHeight <= 1400) return 1 * COIN;
	else if (nHeight >= 1401 && nHeight <=6000) return 3 * COIN;
        else if (nHeight >=6001 && nHeight <=10000) return 10 * COIN;
