/* src/config/roxy-config.h.  Generated from roxy-config.h.in by configure.  */
/* src/config/roxy-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ROXY_CONFIG_H

#define ROXY_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://roxy.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Roxy Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Roxy Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "roxy"
