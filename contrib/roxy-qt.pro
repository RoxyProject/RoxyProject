...
RESOURCES += src/qt/roxy.qrc src/qt/roxy_locale.qrc

TRANSLATIONS += src/qt/locale/roxy_bg.ts \
                src/qt/locale/roxy_de.ts \
                src/qt/locale/roxy_en.ts \
                src/qt/locale/roxy_es.ts \
                src/qt/locale/roxy_fi.ts \
                src/qt/locale/roxy_fr.ts \
                src/qt/locale/roxy_it.ts \
                src/qt/locale/roxy_ja.ts \
                src/qt/locale/roxy_pl.ts \
                src/qt/locale/roxy_pt.ts \
                src/qt/locale/roxy_ru.ts \
                src/qt/locale/roxy_sk.ts \
                src/qt/locale/roxy_sv.ts \
                src/qt/locale/roxy_vi.ts \
                src/qt/locale/roxy_zh_CN.ts \
                src/qt/locale/roxy_zh_TW.ts
